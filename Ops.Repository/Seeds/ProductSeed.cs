    ...
    public class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(new Product { Id=1, CategoryId=1, Name="Tişört", Price=200, Status=Status.Added, Amount=200 },
                ...
                new Product { Id = 9, CategoryId=1, Name = "Kısa Kollu Tişört", Price = 250, Status = Status.Added, Amount=10 },
                new Product { Id = 10, CategoryId=1, Name = "Kısa Kollu Tişört", Price = 350, Status = Status.Added, Amount=10 },
                new Product { Id = 11, CategoryId=1, Name = "Kısa Kollu Tişört", Price = 450, Status = Status.Added, Amount=10 },
                new Product { Id = 12, CategoryId=1, Name = "Kısa Kollu Tişört", Price = 1050, Status = Status.Added, Amount=10 });
        }
    }
}
